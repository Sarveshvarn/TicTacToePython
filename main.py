...
class TicTacToe:
    def __init__(self, game):
        self.game = game
        self.field_image = self.get_scaled_image(path=FIELD_IMAGE, res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path=O_IMAGE, res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path=X_IMAGE, res=[CELL_SIZE] * 2)
